...
const Home: NextPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setError("");
    setSubmitted(true);
    window.location.href = `mailto:hello@juanbertos.com?subject=${t.mailtoSubject}&body=${t.mailtoBody}${encodeURIComponent(email)}`;
    setEmail("");
  };
      ...
      >
        ...
        >
          ...
          >
            ROMA SUR
            <br />
            <span className="text-red-600">{t.heroHeadline2}</span>
          </motion.h1>
            ...
            <div className="mt-16 md:mt-20 grid md:grid-cols-2 gap-12 md:gap-16">
              ...
              <FadeIn delay={0.2}>
                <div className="space-y-6">
                  {[t.productBullet1, t.productBullet2, t.productBullet3].map(
                    (item) => (
            ...
            <FadeIn delay={0.15}>
              <div className="mt-20 pt-16 border-t border-neutral-200">
                <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-neutral-950 leading-snug">
                  {t.productQuote1}
                  <br />
                  <span className="text-red-600">{t.productQuote2}</span>
                </p>
              </div>
            </FadeIn>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <FadeIn>
              <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tighter text-neutral-950 leading-[0.85]">
                {t.beerHeadline1}
                <br />
                <span className="text-red-600">{t.beerHeadline2}</span>
              </h2>
            </FadeIn>
            <FadeIn delay={0.1}>
      ...
      <footer className="py-12 px-6 bg-neutral-950 border-t border-white/5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-4 text-xs text-white/15">
            &copy; {new Date().getFullYear()} Juanberto&apos;s. {t.footerRights}
          </p>
        </div>
      </footer>
    </>
